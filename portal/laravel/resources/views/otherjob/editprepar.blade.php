...
@section('general')
    <div class="container">
        <div class="row">
            {!!  Form::model($cons,['role' => 'form', 'method' => 'PATCH', 'action' => ['OtherController@updateprepare', $cons->id]  ])  !!}
            <div class="col-lg-6">
                <h2>Edit Training : {{ $cons->title }}</h2>
                <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>
                <div class="form-group">
                    <label for="title">Preparation Material Title : </label>
